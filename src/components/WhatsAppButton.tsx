...
export function WhatsAppButton({
    ...
    message = 'Hello! I would like to inquire about visas.'
}: WhatsAppButtonProps) {
    ...
    return (
        <div className="fixed bottom-6 left-6 z-50 group">
            <button
                onClick={handleClick}
                className="flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-110"
